...
!function(e,r){"function"==typeof define&&define.amd?define(function(){return e.Savage=r()}):"object"==typeof exports&&(module.exports=e.Savage=r()),"undefined"!=typeof window&&(window.Savage=e.Savage)}(this,function(){return{Character:require("./Character"),Attribute:require("./Attribute"),Skill:require("./Skill"),Race:require("./Race"),Hindrance:require("./Hindrance")}});
...
var scale=["d4","d6","d8","d10","d12","d12+1","d12+2","d12+3","d12+4"],Trait=function(t){var e=t?scale.indexOf(t):0;Object.defineProperty(this,"factor",{get:function(){return e},set:function(t){e=Math.max(0,Math.min(scale.length,t))}}),Object.defineProperty(this,"value",{get:function(){return scale[this.factor]}}),Object.defineProperty(this,"effect",{get:function(){return 2*this.factor+4}})};Trait.prototype.increase=function(){return scale[++this.factor]},Trait.prototype.decrease=function(){return scale[--this.factor]},Trait.prototype.toString=function(){return"[Trait "+this.value+"]"},module.exports=Trait;
},{}]},{},[1,2,3,4,5,6,7,8,9])