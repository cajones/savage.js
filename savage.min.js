...
var Trait=require("../Trait"),MultiSkillRequirement=function(t,i,e){this.quantity=void 0===e?0:parseInt(e),this.expression=i,this.trait=new Trait(t)};MultiSkillRequirement.prototype.isMet=function(t){return t.skills.filter(function(t){return console.log(t.name,this.expression.test(t.name),t.factor,this.trait.factor),this.expression.test(t.name)&&t.factor>=this.trait.factor}.bind(this)).length>=this.quantity},module.exports=MultiSkillRequirement;
