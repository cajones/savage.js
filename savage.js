...
module.exports = [
    ...
    new Edge('Holy Warrior', [Edge.requires('N'), Edge.requires(Attribute.Spirit, 'd8'), Edge.requires('Faith', 'd6')], 'Call upon your chosen deity to repulse evil creatures', 'Professional Edges'),
    new Edge('Unholy Warrior', [Edge.requires('N'), Edge.requires(Attribute.Spirit, 'd8'), Edge.requires('Faith', 'd6')], 'Call upon your chosen deity to repulse good creatures', 'Professional Edges'),
